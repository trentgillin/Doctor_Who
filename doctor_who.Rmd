...
write_csv(ninth, "data/ninth.csv")
write_csv(tenth, "data/tenth.csv")
write_csv(eleventh, "data/eleventh.csv")
write_csv(twelveth, "data/twelveth.csv")
```
...
word_numbers %>%
  ...
  ggplot(aes(speaker, number_per_character, fill = speaker)) +
